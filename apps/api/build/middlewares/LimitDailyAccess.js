...
function limitDailyAccess(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        const pastes = yield db.query("SELECT * FROM content_modification WHERE api_key = $1 AND content_modification.accessed = CURRENT_DATE;", [req.additional.apiKey]);
        //TODO move limits to some config file
        const limit = req.additional.user === quickpaste_constants_1.default.GUEST_ACCOUNT_ID ? quickpaste_constants_1.default.PASTE.DAILY_CONTENT_LIMITS.guest : quickpaste_constants_1.default.PASTE.DAILY_CONTENT_LIMITS.loggedIn;
