...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.185c31d7.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.989488f0.mjs'));
...
//# sourceMappingURL=error-component.9cf39796.mjs.map
