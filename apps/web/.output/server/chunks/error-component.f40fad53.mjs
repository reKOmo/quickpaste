...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.0d9d53a9.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.a8688f27.mjs'));
...
//# sourceMappingURL=error-component.f40fad53.mjs.map
