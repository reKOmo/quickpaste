globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, version, ref, defineComponent, createElementBlock, useSSRContext, watchEffect, watch, computed, h, resolveComponent, unref, withCtx, createTextVNode, createApp, reactive, shallowRef, isReadonly, effectScope, isRef, isReactive, toRaw, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, markRaw, getCurrentScope, onScopeDispose, nextTick, isShallow, defineAsyncComponent, toRefs, mergeProps, withAsyncContext, Suspense, Transition } from 'vue';
...
import { u as useRuntimeConfig$1, h as createError$1, j as sanitizeStatusCode, a as setCookie, k as getCookie, b as deleteCookie } from '../nitro/node-server.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderTeleport, ssrRenderList, ssrRenderSuspense, ssrRenderVNode, ssrInterpolate, ssrRenderAttr } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Api-Docs-549e8aaa.mjs').then((m) => m.default || m)
  },
  {
    name: "Login",
    path: "/Login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Login-2bde8a38.mjs').then((m) => m.default || m)
  },
  {
    name: "pasteId",
    path: "/:pasteId()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_pasteId_-033e4ff1.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8e3ae329.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "user-Settings",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/user/Settings",
    meta: __nuxt_page_meta$1 || {},
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/Settings-9ed51bd9.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-80a84eef.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth-0966e82e.mjs')
};
...
function defineNuxtLink(options) {
  ...
  const resolveTrailingSlashBehavior = (to, resolve) => {
    ...
    const path2 = "path" in to ? to.path : resolve(to).path;
    return {
      ...to,
      name: void 0,
      // named routes would otherwise always override trailing slash behavior
      path: normalizeTrailingSlash(path2, true)
    };
  };
  return /* @__PURE__ */ defineComponent({
    ...
    setup(props, { slots }) {
      const router = useRouter();
      const to = computed(() => {
        const path2 = props.to || props.href || "";
        return resolveTrailingSlashBehavior(path2, router.resolve);
      });
...
const MarkdownLoader_server_IPUzvlClj8 = /* @__PURE__ */ defineNuxtPlugin({
  name: "FileLoader",
  enforce: "pre",
  async setup(nuxtApp) {
    nuxtApp.provide("loadFile", async (filePath) => {
...
const revive_payload_server_A2zbw30h5H = /* @__PURE__ */ defineNuxtPlugin({
...
const unhead_TZ4KbyAAD6 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const AsserUrlResolver_lCycnAcfcI = /* @__PURE__ */ defineNuxtPlugin(async () => {
  return {
    provide: {
      /**
       * 
...
const plugins = [
  plugin$1,
  MarkdownLoader_server_IPUzvlClj8,
  plugin,
  revive_payload_server_A2zbw30h5H,
  components_plugin_KR1HBZs4kY,
  unhead_TZ4KbyAAD6,
  AsserUrlResolver_lCycnAcfcI,
...
const _imports_0 = "" + __buildAssetsURL("quickpase-icon.40f31740.svg");
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$6 = {
  emits: ["decision"],
  props: {
    title: {
...
var NotificationTypes = /* @__PURE__ */ ((NotificationTypes2) => {
  NotificationTypes2[NotificationTypes2["NOTIFICATION"] = 1] = "NOTIFICATION";
  NotificationTypes2[NotificationTypes2["ALERT"] = 2] = "ALERT";
  NotificationTypes2[NotificationTypes2["CONFIRM"] = 3] = "CONFIRM";
  ...
  setup(__props) {
    ...
    function showAlerts() {
      if (notificationStore.getAlerts().length > 0) {
        ...
        confirm.show = false;
        confirm.notification = void 0;
      }
    }
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NotificationsConfirm = __nuxt_component_0;
      const _component_NotificationsToast = __nuxt_component_1;
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(confirm).show || unref(alert).show) {
          _push2(`<div class="absolute z-10 top-0 w-screen h-screen flex justify-center items-center backdrop-filter backdrop-blur-sm shadow-lg bg-zinc-900/50" data-v-379c6301>`);
          if (unref(confirm).show) {
            _push2(ssrRenderComponent(_component_NotificationsConfirm, {
              class: "notification",
              onDecision: alertDone,
              title: unref(confirm).notification.title,
              description: unref(confirm).notification.description
            }, null, _parent));
          } else {
            _push2(`<!---->`);
          }
        ...
        _push2(`<div class="absolute flex flex-col w-xs sm:w-sm h-3/4 z-60 right-0 justify-end pointer-events-none overflow-hidden" data-v-379c6301><!--[-->`);
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/Default-65cd2aa5.mjs').then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_font_awesome_icon = resolveComponent("font-awesome-icon");
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full bg-zinc-600 text-gray-300 pt-4" }, _attrs))}><div class="flex flex-col space-y-2 items-center"><div><ul class="flex flex-row space-x-8"><li><a href="/">Home</a></li><li><a href="/api-docs">Api</a></li><li><a href="/user">User page</a></li></ul></div></div><p class="text-center p-4 text-lg">Site by <a href="https://github.com/reKOmo">reKOmo (Bartosz Woźnica) `);
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    let __temp, __restore;
    {
      ...
      if (key.value === void 0) {
        console.log(/* @__PURE__ */ useRuntimeConfig());
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_MyNavigation = __nuxt_component_2;
      const _component_NotificationsManager = __nuxt_component_3;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-bf40a306.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-20f85f3d.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.6.0_@types+node@17.0.45_eslint@7.32.0_sass@1.54.6_typescript@4.8.2/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-8d268df2.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.6.0_@types+node@17.0.45_eslint@7.32.0_sass@1.54.6_typescript@4.8.2/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { NotificationTypes as N, _export_sfc as _, __nuxt_component_0$1 as a, useRuntimeConfig as b, createError as c, useNotificationStore as d, entry$1 as default, useNuxtApp as e, useUserStore as f, useRoute as g, useRequestHeaders as h, __nuxt_component_1$2 as i, defineNuxtPlugin as j, defineNuxtRouteMiddleware as k, useCookie as l, navigateTo as n, useHead as u };
