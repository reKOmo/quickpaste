...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.c5971b72.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.0288ad42.mjs'));
...
//# sourceMappingURL=error-component.8501c526.mjs.map
