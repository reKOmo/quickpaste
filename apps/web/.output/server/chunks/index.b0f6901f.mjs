...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-64ff6768>`);
      if (!unref(postingPaste)) {
        _push(`<div class="container" data-v-64ff6768>`);
        ...
        _push(`<div data-v-64ff6768>`);
        if (!unref(createdPaste)) {
          _push(`<div class="flex flex-row justify-center items-center mt-12" data-v-64ff6768><object width="300" height="300" type="image/svg+xml"${ssrRenderAttr("data", unref(_imports_0))} data-v-64ff6768><img${ssrRenderAttr("src", _imports_0)} data-v-64ff6768></object><div class="bg-gradient-to-tr from-green to-orange rounded p-6 h-min" data-v-64ff6768><h2 class="text-2xl font-bold" data-v-64ff6768>Creating paste</h2></div></div>`);
        } else {
          _push(`<div data-v-64ff6768>`);
          if (unref(requestCode) == 200) {
            _push(`<div class="flex flex-row justify-center items-center mt-12" data-v-64ff6768><object width="300" height="300" type="image/svg+xml"${ssrRenderAttr("data", unref(_imports_1))} data-v-64ff6768><img${ssrRenderAttr("src", _imports_1)} data-v-64ff6768></object><div class="doneText bg-gradient-to-tr from-green to-orange rounded p-6 h-min" data-v-64ff6768><h2 class="text-2xl font-bold" data-v-64ff6768>Paste created!</h2><h3 data-v-64ff6768> Check it at: <a class="font-bold"${ssrRenderAttr("href", `/${unref(createdPaste).pasteId}`)} data-v-64ff6768>${ssrInterpolate(unref(createdPaste).pasteId)} `);
          ...
          if (unref(requestCode) == 429) {
            _push(`<div class="flex flex-row justify-center items-center mt-12" data-v-64ff6768><div class="doneText bg-gradient-to-tr from-green to-orange rounded p-6 h-min" data-v-64ff6768><h2 class="text-2xl font-bold" data-v-64ff6768>Daily paste limit reached</h2><h3 data-v-64ff6768> You have surpassed your daily paste limit. For more information see `);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-64ff6768"]]);

export { index as default };
//# sourceMappingURL=index.b0f6901f.mjs.map
