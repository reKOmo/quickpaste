...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.0ed7aefc.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.3834261d.mjs'));
...
//# sourceMappingURL=error-component.e1b05c0e.mjs.map
