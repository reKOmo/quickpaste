...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.6c643ae8.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.2575eaf6.mjs'));
...
//# sourceMappingURL=error-component.822ccf3a.mjs.map
