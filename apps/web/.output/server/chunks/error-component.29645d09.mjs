...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.8a5bb516.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.2541d033.mjs'));
...
//# sourceMappingURL=error-component.29645d09.mjs.map
