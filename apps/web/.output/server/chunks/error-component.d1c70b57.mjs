...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.ba77b057.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.56a3cfdd.mjs'));
...
//# sourceMappingURL=error-component.d1c70b57.mjs.map
