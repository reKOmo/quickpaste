...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.b9b4dd4b.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.9d896dcf.mjs'));
...
//# sourceMappingURL=error-component.73ddff35.mjs.map
