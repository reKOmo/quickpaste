...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.cd58446a.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.82e9d54b.mjs'));
...
//# sourceMappingURL=error-component.7f1afa69.mjs.map
