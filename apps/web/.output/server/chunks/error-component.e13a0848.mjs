...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.0747b899.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.9d47756f.mjs'));
...
//# sourceMappingURL=error-component.e13a0848.mjs.map
