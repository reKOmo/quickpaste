...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.f75fd6a0.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.dba898c0.mjs'));
...
//# sourceMappingURL=error-component.3923ec16.mjs.map
