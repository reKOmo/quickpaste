...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.03d9928a.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.4be91311.mjs'));
...
//# sourceMappingURL=error-component.d16b2ea2.mjs.map
