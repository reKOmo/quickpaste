...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-cdf0ef0a>`);
      if (!unref(postingPaste)) {
        _push(`<div class="container" data-v-cdf0ef0a>`);
        ...
        _push(`<div data-v-cdf0ef0a>`);
        if (!unref(createdPaste)) {
          _push(`<div class="flex flex-row justify-center items-center mt-12" data-v-cdf0ef0a><object width="300" height="300" type="image/svg+xml"${ssrRenderAttr("data", unref(_imports_0))} data-v-cdf0ef0a><img${ssrRenderAttr("src", _imports_0)} data-v-cdf0ef0a></object><div class="bg-gradient-to-tr from-green to-orange rounded p-6 h-min hidden md:block" data-v-cdf0ef0a><h2 class="text-2xl font-bold" data-v-cdf0ef0a>Creating paste...</h2></div></div>`);
        } else {
          _push(`<div data-v-cdf0ef0a>`);
          if (unref(requestCode) == 200) {
            _push(`<div class="flex flex-row justify-center items-center mt-12" data-v-cdf0ef0a><object class="w-100px sm:w-150px md:w-300px transition" type="image/svg+xml"${ssrRenderAttr("data", unref(_imports_1))} data-v-cdf0ef0a><img${ssrRenderAttr("src", _imports_1)} data-v-cdf0ef0a></object><div class="doneText bg-gradient-to-tr from-green to-orange rounded p-6 mt-6 h-min" data-v-cdf0ef0a><h2 class="text-2xl font-bold" data-v-cdf0ef0a>Paste created!</h2><h3 data-v-cdf0ef0a> Check it at: <a class="font-bold"${ssrRenderAttr("href", `/${unref(createdPaste).pasteId}`)} data-v-cdf0ef0a>${ssrInterpolate(unref(createdPaste).pasteId)} `);
          ...
          if (unref(requestCode) == 429) {
            _push(`<div class="flex flex-row justify-center items-center mt-12" data-v-cdf0ef0a><div class="doneText bg-gradient-to-tr from-green to-orange rounded p-6 h-min" data-v-cdf0ef0a><h2 class="text-2xl font-bold" data-v-cdf0ef0a>Daily paste limit reached</h2><h3 data-v-cdf0ef0a> You have surpassed your daily paste limit. For more information see `);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cdf0ef0a"]]);

export { index as default };
//# sourceMappingURL=index.4e2a3b0e.mjs.map
