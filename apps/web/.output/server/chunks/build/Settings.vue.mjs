import { ref, resolveComponent, mergeProps, useSSRContext, createVNode, resolveDynamicComponent } from 'vue';
...
import { d as useNotificationStore, N as NotificationTypes, _ as _export_sfc } from './server.mjs';
import { _ as __nuxt_component_2 } from './UserPanel.vue.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const generateApiKey = _sfc_main$3;
    const deleteAccount = _sfc_main$2;
    const options = [
      {
