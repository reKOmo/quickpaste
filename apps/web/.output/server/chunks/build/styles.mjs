...
const styles = {
  ...
  "pages/[pasteId].vue": () => import('./_pasteId_-styles.DsQmfbKb.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.plvwdW1U.mjs').then(interopDefault),
  "pages/[pasteId].vue?vue&type=style&index=0&scoped=f9506f66&lang.css": () => import('./_pasteId_-styles.DsQmfbKb.mjs').then(interopDefault),
