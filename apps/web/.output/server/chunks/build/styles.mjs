...
const styles = {
  ...
  "pages/[pasteId].vue": () => import('./_pasteId_-styles.ChYUmk4x.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.plvwdW1U.mjs').then(interopDefault),
  "pages/[pasteId].vue?vue&type=style&index=0&scoped=0a9f0b17&lang.css": () => import('./_pasteId_-styles.ChYUmk4x.mjs').then(interopDefault),
