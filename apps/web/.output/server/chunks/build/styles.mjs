...
const styles = {
  ...
  "pages/[pasteId].vue": () => import('./_pasteId_-styles.CKvMrYPT.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.plvwdW1U.mjs').then(interopDefault),
  "pages/[pasteId].vue?vue&type=style&index=0&scoped=6140c2aa&lang.css": () => import('./_pasteId_-styles.CKvMrYPT.mjs').then(interopDefault),
