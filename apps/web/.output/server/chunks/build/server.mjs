import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineComponent, provide, createElementBlock, useSSRContext, h, computed, unref, shallowReactive, Suspense, nextTick, Transition, resolveComponent, withCtx, createTextVNode, mergeProps, createApp, effectScope, reactive, shallowRef, isReadonly, isRef, isReactive, toRaw, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, markRaw, getCurrentScope, onScopeDispose, isShallow, toRefs, withAsyncContext } from 'vue';
...
import { u as useRuntimeConfig$1, m as createError$1, v as getRequestHeaders, w as getRequestHeader, x as sanitizeStatusCode, a as setCookie, y as getCookie, b as deleteCookie, z as createHooks, A as toRouteMatcher, B as createRouter$1 } from '../runtime.mjs';
...
function parseURL$1(input = "", defaultProto) {
  ...
  const [, host = "", path2 = ""] = hostAndPath.match(/([^#/?]*)(.*)?/) || [];
    ...
    (function(a2, u) {
      ...
      const Pn = class Pn {
        ...
        values(t2 = void 0) {
          if (!We(this))
            throw De("values");
          const r = fs2(t2, "First parameter");
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-Bd2l6bo3.mjs');
...
const unhead_vvDVbWACYl = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_pasteId_-DELKKI11.mjs').then((m) => m.default || m)
  },
  {
    name: "Api-Docs",
    path: "/Api-Docs",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./Api-Docs-As-oGwYm.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
...
function defineNuxtLink(options) {
  ...
  function resolveTrailingSlashBehavior(to, resolve) {
    ...
    const path2 = "path" in to && to.path !== void 0 ? to.path : resolve(to).path;
    const resolvedPath = {
      ...to,
      name: void 0,
      // named routes would otherwise always override trailing slash behavior
      path: applyTrailingSlashBehavior(path2, options.trailingSlash)
    };
    return resolvedPath;
  }
  return defineComponent({
    ...
    setup(props, { slots }) {
      ...
      return () => {
        ...
        return h("a", { ref: el2, href, rel, target }, (_b2 = slots.default) == null ? void 0 : _b2.call(slots));
      };
    }
  });
}
...
const revive_payload_server_MtIuAP0X8F = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  ...
  plugin,
  revive_payload_server_MtIuAP0X8F,
...
const useUserStore = defineStore("userStore", {
  ...
  actions: {
    async getUser() {
      const user = await $fetch((/* @__PURE__ */ useRuntimeConfig()).public.webAddress + `/api/user`, {
        credentials: "include",
...
const _imports_0 = "" + __buildAssetsURL("quickpase-icon.D_geJvoW.svg");
...
const _sfc_main$7 = {
  watch: {
    "$route": {
      handler: () => {
        (void 0).getElementById("mobile-menu").classList.toggle("hidden");
      }
    }
  },
  methods: {
...
const useNotificationStore = defineStore("notificationStore", {
  ...
  actions: {
    addNotification(noti) {
      return new Promise((resolve) => {
        const n2 = new Notification(resolve);
        Object.assign(n2, noti);
        n2.id = this.nextId++;
        switch (n2.type) {
          case 2:
          case 3:
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(confirm).show || unref(alert).show) {
          _push2(`<div class="absolute z-10 top-0 w-screen h-screen flex justify-center items-center backdrop-filter backdrop-blur-sm shadow-lg bg-zinc-900/50" data-v-379c6301><template>`);
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    let __temp, __restore;
    {
      ...
      if (key.value === void 0) {
        const res = ([__temp, __restore] = withAsyncContext(() => fetch((/* @__PURE__ */ useRuntimeConfig()).authServiceAddress + "/keys/generate")), __temp = await __temp, __restore(), __temp);
        if (res.ok) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dsl9-S2q.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CQmpDofI.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.11.1_@unocss+reset@0.58.8_eslint@7.32.0_floating-vue@5.2.2_sass@1.72.0_unocss@0.58.8_vite@5.2.7/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-B_fZJO3e.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.11.1_@unocss+reset@0.58.8_eslint@7.32.0_floating-vue@5.2.2_sass@1.72.0_unocss@0.58.8_vite@5.2.7/node_modules/nuxt/dist/app/components/nuxt-root.vue");
