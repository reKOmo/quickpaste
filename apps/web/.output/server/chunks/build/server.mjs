import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, defineComponent, unref, computed, provide, ref, watch, h, isReadonly, isRef, isShallow, isReactive, toRaw, resolveComponent, createElementBlock, withCtx, createTextVNode, useSSRContext, mergeProps, createVNode, defineAsyncComponent, Suspense, nextTick, Fragment, withAsyncContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { m as createHooks, n as getContext, h as createError$1, t as toRouteMatcher, o as createRouter$1, q as defu, v as hasProtocol, w as joinURL, x as withQuery, y as sanitizeStatusCode, z as isScriptProtocol, A as executeAsync, B as parseQuery$1, C as withTrailingSlash, D as withoutTrailingSlash, E as getRequestHeaders, l as destr, F as klona, G as parse, H as getRequestHeader, I as isEqual, a as setCookie, J as getCookie, b as deleteCookie } from '../nitro/nitro.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderTeleport, ssrRenderList, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const unhead_aii9es3ywVTpuy9EIbeEBbVhz_5h7OCd_K_gHGKz_Qg = defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  ...
  },
  {
    name: "Api-Docs",
    path: "/Api-Docs",
    component: () => import('./Api-Docs.vue.mjs')
  },
  {
    name: "user",
    path: "/user",
  ...
  },
  {
    name: "paste-pasteId",
    path: "/paste/:pasteId()",
    component: () => import('./_pasteId_.vue.mjs')
  }
];
...
const MarkdownLoader_server_kjLB1MhhgXAH84cTfJpDVFFC_WlK9brHkr494tUaPlY = defineNuxtPlugin({
  name: "FileLoader",
  enforce: "pre",
  async setup(nuxtApp) {
...
const revive_payload_server_8o7aOwAgorenET694YyxjA2SEHakJ0JScGPErNmxXu0 = defineNuxtPlugin({
...
const AsserUrlResolver_O9gWWKdTcpAkmSACV0xaUFFEf9CgsONdQ8tsx_rYtik = defineNuxtPlugin(async () => {
  return {
    provide: {
      /**
       * 
...
const fontawesome_PhDYKScvhD9vuK4NrUE_o9xIMP79DebxTp7lochwkQ0 = defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.component("FontAwesomeIcon", FontAwesomeIcon);
});

const plugins = [
  payloadPlugin,
  unhead_aii9es3ywVTpuy9EIbeEBbVhz_5h7OCd_K_gHGKz_Qg,
  plugin$1,
  MarkdownLoader_server_kjLB1MhhgXAH84cTfJpDVFFC_WlK9brHkr494tUaPlY,
  revive_payload_server_8o7aOwAgorenET694YyxjA2SEHakJ0JScGPErNmxXu0,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  AsserUrlResolver_O9gWWKdTcpAkmSACV0xaUFFEf9CgsONdQ8tsx_rYtik,
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NuxtLink = __nuxt_component_0$1;
  const _component_Login = _sfc_main$8;
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.16.2_eslint@7.32.0_sass@1.86.3_vite@6.2.5/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.16.2_eslint@7.32.0_sass@1.86.3_vite@6.2.5/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { NotificationTypes as N, _export_sfc as _, __nuxt_component_0$1 as a, useUserStore as b, createError as c, useNotificationStore as d, useRuntimeConfig as e, useRoute$1 as f, __nuxt_component_1$1 as g, useNuxtApp as h, injectHead as i, asyncDataDefaults as j, useRequestHeaders as k, defineNuxtPlugin as l, defineNuxtRouteMiddleware as m, useCookie as n, navigateTo as o, server as s, useHead as u };
