import { k as defineNuxtPlugin } from './server.mjs';
...
(function() {
  ...
  function addScript(src2, success, error) {
    var s = (void 0).createElement("script");
    s.src = src2;
    s.async = true;
    s.onload = function() {
      (void 0).body.removeChild(s);
      success && success();
    };
    s.onerror = function() {
      (void 0).body.removeChild(s);
...
Prism$2.manual = true;
const Prism$1 = defineNuxtPlugin(Prism$2);

export { Prism$1 as P };
//# sourceMappingURL=prismjs.client-e_DZ7_Vi.mjs.map
