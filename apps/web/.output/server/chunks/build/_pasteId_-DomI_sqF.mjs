...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-1ee6c023>`);
      if (unref(paste)) {
        _push(`<div data-v-1ee6c023>`);
        if (unref(pastePostingState) == 0) {
          ...
          _push(`<div class="flex flex-row justify-center items-center mt-12" data-v-1ee6c023><object width="300" height="300" type="image/svg+xml"${ssrRenderAttr("data", unref(_imports_0))} data-v-1ee6c023><img${ssrRenderAttr("src", _imports_0)} data-v-1ee6c023></object><div class="bg-gradient-to-tr from-green to-orange rounded p-6 h-min hidden md:block" data-v-1ee6c023><h2 class="text-2xl font-bold" data-v-1ee6c023>Creating paste</h2></div></div>`);
        } else {
          _push(`<div class="flex flex-row justify-center items-center mt-12" data-v-1ee6c023><object class="w-100px sm:w-150px md:w-300px" type="image/svg+xml"${ssrRenderAttr("data", unref(_imports_1))} data-v-1ee6c023><img${ssrRenderAttr("src", _imports_1)} data-v-1ee6c023></object><div class="doneText bg-gradient-to-tr from-green to-orange rounded p-6 h-min" data-v-1ee6c023><h2 class="text-2xl font-bold" data-v-1ee6c023>Paste created!</h2><h3 data-v-1ee6c023> Check it at: <a class="font-bold"${ssrRenderAttr("href", `/${(_a = unref(createdPaste)) == null ? void 0 : _a.pasteId}`)} data-v-1ee6c023>${ssrInterpolate((_b = unref(createdPaste)) == null ? void 0 : _b.pasteId)} `);
        ...
        _push(`<div data-v-1ee6c023>`);
        if (unref(err) == 401) {
          _push(`<div class="flex flex-col items-center space-y-4" data-v-1ee6c023><h2 class="text-xl text-gray-300" data-v-1ee6c023>Enter password to view the paste</h2><div class="flex flex-col md:flex-row space-y-2 md:space-y-0" data-v-1ee6c023><input${ssrRenderAttr("value", unref(password))} type="password" autocomplete="off" class="p-2 w-full md:w-auto text-center text-white rounded border-none focus:outline-none text-lg text-bold bg-darkgray mr-4" data-v-1ee6c023><button class="bg-gradient-to-tr from-green to-orange rounded p-2 text-center hover:shadow-lg" data-v-1ee6c023>Enter</button></div></div>`);
        } else {
          _push(`<div data-v-1ee6c023><div class="flex flex-col justify-center content-center text-center bg-gradient-to-tr from-green to-orange mb-4 p-4 rounded" data-v-1ee6c023><h1 class="text-3xl text-white text-shadow-sm" data-v-1ee6c023> No paste here </h1></div></div>`);
        }
        _push(`</div>`);
      }
      _push(`</div>`);
...
const _pasteId_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1ee6c023"]]);

export { _pasteId_ as default };
//# sourceMappingURL=_pasteId_-DomI_sqF.mjs.map
