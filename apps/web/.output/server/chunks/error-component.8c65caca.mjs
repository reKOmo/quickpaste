...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.ccfaf185.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.8b55f189.mjs'));
...
//# sourceMappingURL=error-component.8c65caca.mjs.map
