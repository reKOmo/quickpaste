...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.2d80bad9.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.78e2bac6.mjs'));
...
//# sourceMappingURL=error-component.bdada28c.mjs.map
