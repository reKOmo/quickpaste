...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.ebc39b7a.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.66ec8954.mjs'));
...
//# sourceMappingURL=error-component.efc20f4e.mjs.map
