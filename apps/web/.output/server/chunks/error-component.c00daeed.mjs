...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.f0aef8db.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.5f312c62.mjs'));
...
//# sourceMappingURL=error-component.c00daeed.mjs.map
