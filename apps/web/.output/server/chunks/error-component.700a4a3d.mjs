...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.28cc833b.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.209ca895.mjs'));
...
//# sourceMappingURL=error-component.700a4a3d.mjs.map
