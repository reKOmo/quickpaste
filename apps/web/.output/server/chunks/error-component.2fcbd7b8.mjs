...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.ad86c341.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.3a2db3a6.mjs'));
...
//# sourceMappingURL=error-component.2fcbd7b8.mjs.map
