...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.bf0b9411.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.2641ed2e.mjs'));
...
//# sourceMappingURL=error-component.f6dc0dc6.mjs.map
