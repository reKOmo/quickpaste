...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.3f009e6f.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.eaa6b51f.mjs'));
...
//# sourceMappingURL=error-component.75bad217.mjs.map
