...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.13a9b1ec.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.bc729e38.mjs'));
...
//# sourceMappingURL=error-component.43163bb4.mjs.map
