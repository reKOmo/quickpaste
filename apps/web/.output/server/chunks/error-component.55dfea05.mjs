...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.91c0cd22.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.70e6d3ad.mjs'));
...
//# sourceMappingURL=error-component.55dfea05.mjs.map
