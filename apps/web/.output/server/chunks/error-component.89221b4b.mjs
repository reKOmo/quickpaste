...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.a31db9d7.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.d37d0c43.mjs'));
...
//# sourceMappingURL=error-component.89221b4b.mjs.map
