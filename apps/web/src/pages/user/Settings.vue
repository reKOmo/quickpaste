<template>
    <div class="flex flex-col md:flex-row w-full justify-between">
        ...
        <div class="md:w-4/5">
            <div v-if="option">
                <div
                    class="w-full flex justify-center items-center pt-2 text-xl border-b-1 border-black mb-2 text-gray-200">
                    <font-awesome-icon :icon="['fas', 'fa-arrow-left']" @click="changeOption(undefined)"
