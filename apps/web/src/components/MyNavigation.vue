            ...
            <div
                ...
                <div class="flex felx-row justify-between flex-1 md:flex-none">
                    ...
                    <button @click="toggleMobileMenu" type="button"
                        class="inline-flex items-center p-2 ml-3 text-sm text-black rounded-lg md:hidden hover:bg-green focus:outline-none"
                ...
                <div class="hidden flex-1 md:flex md:flex-row justify-between items-center" id="mobile-menu">
                    <ul
